...
<body style="background-image: url('http://cba.ca/Assets/CBA/Images/Article/tiles/tile_rowHouses.jpg');">
    ...
    <br><br><br>
    <div class="container">
        <h2 class="text-center pt-4" style="color: black; font-weight: bold;">Transaction History</h2>
            ...
            <table class="table table-hover table-striped table-condensed table-bordered">
                ...
                <tbody>
                    ...
                    ?>
                        ...
                        <tr style="color: black; font-weight: 200;">
                            <td class="center py-2"><?php echo $rows['sno']; ?></td>
